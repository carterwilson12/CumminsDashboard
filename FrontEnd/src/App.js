...
function App() {
  ...
  const downloadCSV = () => {
    const TSNdata = TSNdataID.map((t) => ({
      id: t.PRD_SERIAL_NUMBER,
      MES_SRNO_STATUS: t.MES_SRNO_STATUS,
      VOC_INSPECTION_STATUS: t.VOC_INSPECTION_STATUS,
    }));
    ...
    if (results.length === 0) {
      ...
      return (
        <Typography variant="subtitle1">
          Insuffcient Search Criteria.
          <br />
          You must select a Query.
        </Typography>
      );
    }
  };
  ...
  const tsn_other = TSNdataID.filter(
    (item) => item.MES_SRNO_STATUS !== "04" && item.MES_SRNO_STATUS !== "03"
  );
              ...
              {results.map((d) =>
                d === "blank" ? (
                  ...
                  <ToggleButton
                    style={{
                      backgroundColor:
                        currWIP === d.WIP_JOB_NUMBER ? "#2c387e" : "white",
                      color: currWIP === d.WIP_JOB_NUMBER ? "white" : undefined,
                    }}
                    key={d.WIP_JOB_NUMBER}
                    value={d.WIP_JOB_NUMBER}
                    className="WIP-selector-button"
                    onClick={(e) =>
                      TSN(
                        d.WIP_JOB_NUMBER,
                        BOM(d.WIP_JOB_NUMBER),
                        WIPS(d.WIP_JOB_NUMBER)
                      )
                    }
                  >
                    WIP: {d.WIP_JOB_NUMBER} <br />
                    ID21: {d.ID21_ITEM_NUMBER}
                    <br />
                    QTY: {d.WIP_JOB_QTY}
                  </ToggleButton>
                )
          ...
          <TableContainer component={Paper}>
            ...
            >
              <TableHead>
                ...
                <TableRow>
                  <TableCell
                    style={{ backgroundColor: "#df1f1f", height: "5px" }}
                    sx={{ fontWeight: "bold", m: 1 }}
                  ></TableCell>
                  <TableCell
                    style={{ backgroundColor: "#0ab919", height: "5px" }}
                    sx={{ fontWeight: "bold", m: 1 }}
                  ></TableCell>
                  <TableCell
                    style={{ backgroundColor: "#ebc90a", height: "5px" }}
                    sx={{ fontWeight: "bold", m: 1 }}
                  ></TableCell>
                </TableRow>
              </TableHead>
            ...
            >
              ...
              <TableBody>
                {WIPData.map((b) => (
                  <TableRow>
                    <TableCell>
                      <span style={{ fontWeight: "bold", m: 1 }}>Model #</span>{" "}
                      <br /> {b.MODEL_NUMBER}
                    </TableCell>
                    <TableCell>
                      <span style={{ fontWeight: "bold", m: 1 }}>ID21</span>{" "}
                      <br />
                      {b.ID21_ITEM_NUMBER}
                    </TableCell>
                    <TableCell>
                      <span style={{ fontWeight: "bold", m: 1 }}>WIP Type</span>
                      <br />
                      {b.WIP_TYPE}
                    </TableCell>
                  </TableRow>
                ...
                {WIPData.map((b) => (
                  <TableRow>
                    <TableCell>
                      <span style={{ fontWeight: "bold", m: 1 }}>
                        Turbo Type
                      </span>
                      <br />
                      {b.TURBO_TYPE}
                    ...
                    <TableCell>
                      <span style={{ fontWeight: "bold", m: 1 }}>Customer</span>
                      <br />
                ...
                {WIPData.map((b) => (
                  <TableRow>
                    <TableCell>
                      <span style={{ fontWeight: "bold", m: 1 }}>SCH Ship</span>{" "}
                      <br />
                      {b.SCH_SHIP_DATE}
                    </TableCell>
                    <TableCell>
        ...
        <Grid item xs={5}>
          ...
          <div style={{ height: 355, width: "100%" }}>
            <DataGrid
              ...
              rows={TSNdataID.map((t) => ({
                id: t.PRD_SERIAL_NUMBER,
                wip: t.WIP_JOB_NUMBER,
                id21: t.ID21_ITEM_NUMBER,
                MES_SRNO_STATUS: t.MES_SRNO_STATUS,
                VOC_INSPECTION_STATUS: t.VOC_INSPECTION_STATUS,
              }))}
              columns={TSNcolumns}
            ...
            <div>
              ...
              >
                <Box sx={style}>
                  <DataGrid
                    rows={TSN_REJdata.map((tr) => ({
                      id: tr.COMPONENT_ITEM_NUMBER,
                      COMPONENT_DESCRIPTION: tr.COMPONENT_DESCRIPTION,
                    }))}
                    columns={BOMcolumns}
                    initialState={{
                      pagination: {
          ...
          <div style={{ height: 355, width: "100%" }}>
            <DataGrid
              rows={BOMdata.map((b) => ({
                id: b.COMPONENT_ITEM_NUMBER,
                COMPONENT_DESCRIPTION: b.COMPONENT_DESCRIPTION,
              }))}
              columns={BOMcolumns}
              initialState={{
                pagination: {
